...
use App\Models\I7RutinOpdRankir;
...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('j6_subrincian_rutin_rankirs', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(I7RutinOpdRankir::class);
    ...
    {
        Schema::dropIfExists('j6_subrincian_rutin_rankirs');
    }
};
