...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('g2_pendapatan_uraian_ranwals', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(G2PendapatanRanwal::class);
            $table->integer('kode');
    ...
    {
        Schema::dropIfExists('g2_pendapatan_uraian_ranwals');
    }
};
