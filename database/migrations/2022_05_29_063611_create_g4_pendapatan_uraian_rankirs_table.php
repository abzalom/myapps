...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('g4_pendapatan_uraian_rankirs', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(G4PendapatanRankir::class);
            $table->integer('kode');
    ...
    {
        Schema::dropIfExists('g4_pendapatan_uraian_rankirs');
    }
};
