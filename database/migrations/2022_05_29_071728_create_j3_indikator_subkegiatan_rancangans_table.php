...
use App\Models\I3RenjaOpdRancangan;
...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('j3_indikator_subkegiatan_rancangans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(I3RenjaOpdRancangan::class);
    ...
    {
        Schema::dropIfExists('j3_indikator_subkegiatan_rancangans');
    }
};
