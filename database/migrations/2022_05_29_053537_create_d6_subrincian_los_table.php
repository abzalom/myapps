...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('d6_subrincian_los', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignIdFor(D5RincianLo::class);
            ...
            $table->text('uraian');
            $table->text('kategori_ssh')->nullable();
            $table->text('kode_kategori_ssh')->nullable();
    ...
    {
        Schema::dropIfExists('d6_subrincian_los');
    }
};
