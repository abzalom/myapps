<x-app-layout title="{{ $title }}">
                ...
                <table class="table table-borderless">
                    <tbody>
                        <tr class="0-0">
                            ...
                            <td class="pt-0 pb-0 pe-0 ps-0">: {{ $opd->rkaranwal->programrka->kode_unik_program }} - {{ $opd->rkaranwal->programrka->uraian }}</td>
                            <td class="pt-0 pb-0">
                        ...
                        <tr>
                            ...
                            <td class="pt-0 pb-0 pe-0 ps-0">: {{ $opd->rkaranwal->kegiatanrka->kode_unik_kegiatan }} - {{ $opd->rkaranwal->kegiatanrka->uraian }}</td>
                            <td class="pt-0 pb-0">
                        ...
                        <tr>
                            ...
                            <td class="pt-0 pb-0 pe-0 ps-0">: {{ $opd->rkaranwal->subkegiatanrka->kode_unik_subkegiatan }} - {{ $opd->rkaranwal->subkegiatanrka->uraian }}</td>
                            <td class="pt-0 pb-0">
                        ...
                        <tr>
                            ...
                            <td class="pt-0 pb-0 pe-0 ps-0">: {{ ucwords($opd->rkaranwal->subrincianrka->rincian) }}</td>
                            <td class="pt-0 pb-0">
                        ...
                        <tr>
                            ...
                            <td class="pt-0 pb-0 pe-0 ps-0">: Rp. {{ number_format($opd->rkaranwal->subrincianrka->anggaran, 2, ',', '.') }}</td>
                            <td class="pt-0 pb-0">
                        ...
                        <tr>
                            ...
                            <td class="pt-0 pb-0 pe-0 ps-0">: {{ $opd->rkaranwal->subrincianrka->target }} {{ $opd->rkaranwal->subkegiatanrka->satuan }}</td>
                            <td class="pt-0 pb-0">
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="col-3 p-0 m-1" style="width: 18%">
                <div class="card text-white bg-secondary mb-3" style="max-width:100%; height:auto">
                    <div class="card-body p-2 m-0">
                        ...
                        <p class="p-0 m-0 fw-bold">Rp. {{ number_format($opd->rkaranwal->subrincianrka->anggaran, 2, ',', '.') }}</p>
                    </div>
                </div>
            </div>
            <div class="col-3 p-0 m-1" style="width: 18%">
            ...
            <div class="col-3 p-0 m-1" style="width: 18%">
                <div class="card text-white bg-success mb-3" style="max-width:100%; height:auto">
                    <div class="card-body p-2 m-0">
                        ...
                        <p class="p-0 m-0 fw-bold">Rp. {{ number_format($opd->rkaranwal->subrincianrka->anggaran - $totalrka, 2, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            @foreach ($objek->rincian as $rincian)
                                ...
                                @foreach ($rincian->subrincian as $subrincian)
                                    ...
                                    @php
                                        $i = 1;
                                    @endphp
                                    @foreach ($subrincian->rkaranwalkomponen as $komponen)
                                    @php
                                        $pajak = 0;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-grid gap-2 d-md-flex justify-content-center">
                                                    ...
                                                    <a href="{{ route('rkaranwal.rkaranwaldelete', encrypt($komponen->id)) }}" class="btn btn-sm btn-danger delete-rka-rutin"><i class="fa-solid fa-trash fa-lg"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    @include('script.rkaranwalscript')
    @include('rkaopdranwal.modalranwal.modaladdrkaranwal')
    @include('rkaopdranwal.modalranwal.modaleditrkaranwal')
    @include('rkaopdranwal.modalranwal.modalarsiprkaranwal')
</x-app-layout>
