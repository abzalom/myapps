<x-app-layout title="{{ $title }}">
        ...
        <div class="row mt-4 mb-4">
            ...
            <div class="col-6 text-end">
                <a href="{{ route('ssh.sshexport', 3) }}" class="btn btn-success text-white"><i class="fa-solid fa-file-excel fa-lg"></i> Export</a>
        ...
        <div class="table-responsive mt-4 mb-4">
            <table class="table table-bordered table-hover table-striped datatables-asb" style="width: 150%">
    ...
    @include('script.asbscript')
    @include('standarharga.asb.modalasb.modaladdasb')
    @include('standarharga.asb.modalasb.modaleditasb')
    @include('standarharga.asb.modalasb.modaluploadasb')
    @include('standarharga.asb.modalasb.modaldeleteasb')
</x-app-layout>
