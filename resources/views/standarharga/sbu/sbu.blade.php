<x-app-layout title="{{ $title }}">
        ...
        <div class="row mt-4 mb-4">
            ...
            <div class="col-6 text-end">
                <a href="{{ route('ssh.sshexport', 4) }}" class="btn btn-success text-white"><i class="fa-solid fa-file-excel fa-lg"></i> Export</a>
    ...
    @include('script.sbuscript')
    @include('standarharga.sbu.modalsbu.modaladdsbu')
    @include('standarharga.sbu.modalsbu.modaleditsbu')
    @include('standarharga.sbu.modalsbu.modaluploadsbu')
    @include('standarharga.sbu.modalsbu.modaldeletesbu')
</x-app-layout>
