<!-- Modal -->
<div class="modal fade" id="addRincianPendatanModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addRincianPendatanModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="addRincianPendatanModalLabel">
                    Tambah Komponen
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('pendapatan.storeuraian') }}" method="POST">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" name="c6_subrincian_lra_id" id="subrincianid">
                    <div class="mb-3">
