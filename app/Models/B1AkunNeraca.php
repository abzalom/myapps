...
class B1AkunNeraca extends Model
{
    ...
    /**
     * Get all of the kelompok for the B1AkunNeraca
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function kelompok(): HasMany
    {
        return $this->hasMany(B2KelompokNeraca::class);
    }

    /**
     * Get all of the kelompok_kode for the B1AkunNeraca
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function kelompok_kode(): HasMany
    {
